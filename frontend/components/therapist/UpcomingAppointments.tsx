...
const TherapistAppointments = () => {
  ...
  // FIX: Added missing error state to prevent ReferenceError
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    {apt.status === "confirmed" && (
                      <button
                        ...
                        className="flex items-center px-6 py-3 bg-green-500 text-white rounded-xl font-bold text-sm hover:bg-green-600 transition shadow-lg shadow-green-100"
                      >
